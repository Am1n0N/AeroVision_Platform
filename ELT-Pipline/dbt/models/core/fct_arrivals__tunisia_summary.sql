...
base_arrivals__tunisia as (

    select * from {{ ref('base_arrivals__tunisia') }}

),

latest_arrival_date as (

    select max(arrival_date) as arrival_date from base_arrivals__tunisia
