	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				airport_etl.load_dim_aircraft_0_1.Load_Dim_Aircraft childJob_tRunJob_1 = new airport_etl.load_dim_aircraft_0_1.Load_Dim_Aircraft();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				airport_etl.load_dim_flight_status_0_1.Load_Dim_Flight_Status childJob_tRunJob_4 = new airport_etl.load_dim_flight_status_0_1.Load_Dim_Flight_Status();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				airport_etl.load_dim_airport_0_1.Load_Dim_Airport childJob_tRunJob_3 = new airport_etl.load_dim_airport_0_1.Load_Dim_Airport();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				airport_etl.load_dim_airline_0_1.Load_Dim_Airline childJob_tRunJob_2 = new airport_etl.load_dim_airline_0_1.Load_Dim_Airline();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				airport_etl.load_fact_flight_operations_0_1.Load_Fact_Flight_Operations childJob_tRunJob_5 = new airport_etl.load_fact_flight_operations_0_1.Load_Fact_Flight_Operations();
				// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Main.class.getClassLoader()
					.getResourceAsStream("airport_etl/main_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 58299 characters generated by Talend Open Studio for Data Integration on the
 * August 16, 2025 at 3:43:21 AM GMT+01:00
 ************************************************************************************************/